...
{
    public class VendorClassRepositoryTests : AccountPayableEntityFrameworkCoreTestBase
    {
        private readonly IVendorClassRepository _vendorClassRepository;

        public VendorClassRepositoryTests()
        {
            _vendorClassRepository = GetRequiredService<IVendorClassRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _vendorClassRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("9f0e1107-c8f8-429f-9cc5-1231e1cdce05"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _vendorClassRepository.GetCountAsync(
