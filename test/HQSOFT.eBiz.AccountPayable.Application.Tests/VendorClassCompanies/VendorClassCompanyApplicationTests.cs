...
namespace HQSOFT.eBiz.AccountPayable.VendorClassCompanies
{
    public class VendorClassCompaniesAppServiceTests : AccountPayableApplicationTestBase
    {
        ...
        public async Task GetListAsync()
        {
            ...
            result.Items.Any(x => x.Id == Guid.Parse("562e615b-a925-4278-a24a-19e5481e1d02")).ShouldBe(true);
            result.Items.Any(x => x.Id == Guid.Parse("17017f37-6683-4b2d-bf3c-7089fb313500")).ShouldBe(true);
        }
