...
namespace HQSOFT.eBiz.AccountPayable.Blazor.Pages.AccountPayable.VendorClass
{
    public partial class VendorClassListView
    {
        ...
        private DataGridEntityActionsColumn<VendorClassDto> EntityActionsColumn { get; set; } = new();
        protected string SelectedCreateTab = "vendorClass-create-tab";
        protected string SelectedEditTab = "vendorClass-edit-tab";
        
        public VendorClassListView()
        {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            Toolbar.AddButton(L["NewVendorClass"], async () =>
            {
                await OpenCreateVendorClassModalAsync();
