...
namespace HQSOFT.eBiz.AccountPayable.VendorClassAttributes
{
    public class VendorClassAttributeManager : DomainService
    {
        ...
        Guid? vendorClassId, bool isActive, string idAttribute, int sortOrder, bool isRequired, bool isInternal, string controlType, string defaultValue, int idx)
        {
        ...
        public async Task<VendorClassAttribute> UpdateAsync(
            Guid id,
            Guid? vendorClassId, bool isActive, string idAttribute, int sortOrder, bool isRequired, bool isInternal, string controlType, string defaultValue, int idx, [CanBeNull] string concurrencyStamp = null
        )
        {
