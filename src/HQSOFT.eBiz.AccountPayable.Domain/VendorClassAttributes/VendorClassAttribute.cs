...
namespace HQSOFT.eBiz.AccountPayable.VendorClassAttributes
{
    public class VendorClassAttribute : AuditedAggregateRoot<Guid>
    {
        ...
        public VendorClassAttribute(Guid id, Guid? vendorClassId, bool isActive, string idAttribute, int sortOrder, bool isRequired, bool isInternal, string controlType, string defaultValue, int idx)
        {
