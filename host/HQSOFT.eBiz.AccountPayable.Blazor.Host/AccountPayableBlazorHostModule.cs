...
using HQSOFT.eBiz.AccountPayable.Blazor.WebAssembly;
...
[DependsOn(
    ...
    typeof(AccountPayableBlazorWebAssemblyModule)
)]
public class AccountPayableBlazorHostModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(AccountPayableBlazorHostModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new AccountPayableHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("AccountPayable");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<AccountPayableBlazorHostModule>();
        });
    }
}
