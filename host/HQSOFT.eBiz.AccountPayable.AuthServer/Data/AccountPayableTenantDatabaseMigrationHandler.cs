...
namespace HQSOFT.eBiz.AccountPayable.Data;

public class AccountPayableTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<AccountPayableTenantDatabaseMigrationHandler> _logger;

    public AccountPayableTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<AccountPayableTenantDatabaseMigrationHandler> logger)
    {
