 ...
 * - HQSOFT.eBiz.AccountPayable.AuthServer
 * - HQSOFT.eBiz.AccountPayable.Web.Unified (used as linked file)
 */
public class AccountPayableSampleIdentityDataSeeder : ITransientDependency
{
    ...
    public AccountPayableSampleIdentityDataSeeder(
